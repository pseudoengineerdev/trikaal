...
from trikaal_api.parity import run_reference_parity_suite_check  # noqa: E402
...
def main() -> None:
    ...
    result = run_reference_parity_suite_check(include_unverified=args.include_unverified)
