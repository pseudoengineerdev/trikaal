...
class ReportAstronomy {
  const ReportAstronomy({
    ...
    required this.drikDisplayOffsetDeg,
    required this.drikLagnaDisplayOffsetDeg,
  ...
  final double drikDisplayOffsetDeg;
  final double drikLagnaDisplayOffsetDeg;
  ...
  factory ReportAstronomy.fromJson(Map<String, dynamic> json) {
    return ReportAstronomy(
      ...
      drikDisplayOffsetDeg: _readDouble(json, 'drik_display_offset_deg'),
      drikLagnaDisplayOffsetDeg:
          _readDouble(json, 'drik_lagna_display_offset_deg'),
