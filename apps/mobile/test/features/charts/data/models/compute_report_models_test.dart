...
void main() {
  group('ComputeReportResponse', () {
    test('fromJson parses strict report contract payload', () {
      ...
      expect(parsed.snapshot.varga.divisionByCode('d10'), isNotNull);
      expect(
        parsed.snapshot.varga.d1.grahaPositions['sun']!.degreeInSignDeg,
        18.02,
      );
  ...
  return <String, dynamic>{
    ...
    'snapshot': <String, dynamic>{
      ...
      'varga': <String, dynamic>{
        ...
        'd10': _sampleDivision(lagnaRashi: 'Kany'),
      },
